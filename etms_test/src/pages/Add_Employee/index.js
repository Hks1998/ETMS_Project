    ...
    return (
        ...
        <form>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input  onChange={(e) => {
              setEmail(e.target.value) }} type="email" class="form-control" id="inputPassword3"></input>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input  onChange={(e) => {
              setPassword(e.target.value)}} type="text" class="form-control" id="inputEmail3"></input>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input  onChange={(e) => {
              setDesignation(e.target.value)}} type="text" class="form-control" id="inputPassword3"></input>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input  onChange={(e) => {
              setPhone(e.target.value)}} type="text" class="form-control" id="inputEmail3"></input>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input  onChange={(e) => {
              setManagerId(e.target.value)}} type="text" class="form-control" id="inputPassword3"></input>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input  onChange={(e) => {
              setDept(e.target.value)}} type="text" class="form-control" id="inputPassword3"></input>
                </div>
            </div>
            <div className="row">
                <div className="col">Role</div>
                <div className="col"><select  onChange={(e) => {
              setRole(e.target.value)}} class="form-select" aria-label="Default select example">
